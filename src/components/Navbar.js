...
export default function Navbar({ title = 'Set title here', aboutText = 'About', mode, toggleMode }) {
    ...
    const handleToggleChange = () => {
        toggleMode(); // Calls the function to toggle the mode
    };
...
Navbar.propTypes = {
    ...
    mode: PropTypes.string.isRequired, // Ensure mode is passed as a prop
    toggleMode: PropTypes.func.isRequired // Ensure toggleMode is passed as a prop
};
